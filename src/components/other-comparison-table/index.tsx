			...
			<table className="w-full border-collapse overflow-auto rounded-lg border bg-white shadow-lg">
				<caption className="caption-bottom">
					<p className="mt-6 text-lg text-gray-600">
						...
						<span className="font-bold text-primary-900">Green Color</span> highlighted text indicated
						test results where Canary has a differentiated advantage.
					</p>
				</caption>

				<thead>
					<tr className="bg-primary-50 text-xl font-bold opacity-100">
						...
						<th className="w-1/4 p-6 text-center text-red-900">Top U.S. and Indian Competitors</th>
					</tr>
				</thead>

				<tbody>
					<tr className="border-b border-gray-200 opacity-100">
						...
						<td className="p-3 text-center text-xl font-bold">1091 (+637 Variants)</td>
						<td className="p-3 text-center text-xl font-bold">468 (+37 Variants)</td>
						<td className="p-3 text-center text-xl">
							{' '}
							<span className="text-red-500">300-500</span>
						</td>
					</tr>
					...
					<tr className="border-b border-gray-200">
						<td colSpan={4} className="p-3 text-center text-lg font-semibold">
							In Development
						</td>
					</tr>
